<x-app-layout>
    <title>Bayajidda Global - Hotel Booking Service</title>
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6 col-12">
                        <h3 class="mb-0 fw-bold">Hotel Booking Service</h3>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row g-3 align-items-center">
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="search" class="form-control border-start-0 bg-light py-2" placeholder="Search Ref, Agent..." value="{{ request('search') }}">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-3 d-flex gap-2">
                                    ...
                                    @if(request('status') || request('search'))
                                        <a href="{{ route('hotel.index') }}" class="btn btn-outline-danger py-2">Clear</a>
                                    @endif
                                </div>
                            </div>
                        </form>
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 1.25rem;">
            <div class="card-header bg-white py-4 border-bottom-0 d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold text-dark d-flex align-items-center">
                    <i class="ti ti-building-skyscraper me-2 text-primary fs-22"></i>
                            ...
                            @forelse ($enrollments as $enrollment)
                                <tr>
                                    ...
                                    <td class="pe-4 text-end">
                                        <a href="{{ route('hotel.show', $enrollment->id) }}" class="btn btn-icon btn-light btn-sm rounded-circle"><i class="ti ti-eye text-primary"></i></a>
                                    </td>
                                </tr>
                            @empty
                                <tr><td colspan="7" class="text-center py-5 text-muted">No hotel bookings found.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
