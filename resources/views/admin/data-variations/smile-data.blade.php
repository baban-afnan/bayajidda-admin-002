<x-app-layout>
    <title>Bayajidda Global - Smile Data Services</title>
    ...
    <div class="content">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="page-title text-primary mb-1 fw-bold">Smile Data Plans</h3>
                ...
                <div class="col-md-6 text-center mt-2 mt-md-0 d-flex gap-2 justify-content-end align-items-center">
                    <form action="{{ route('admin.smile-data.sync') }}" method="POST" id="syncForm" class="m-0">
                        @csrf
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body">
                <form action="{{ route('admin.smile-data.index') }}" method="GET" class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end gap-2">
                        ...
                        <a href="{{ route('admin.smile-data.index') }}" class="btn btn-light flex-fill">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom py-3">
                <h5 class="card-title mb-0 fw-bold"><i class="ti ti-list-details me-2 text-primary"></i>Available Smile Plans</h5>
            </div>
                                ...
                                <tr class="border-bottom-soft">
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="d-flex justify-content-end gap-2">
                                            ...
                                            <form action="{{ route('admin.smile-data.destroy', $variation->id) }}" method="POST" class="delete-plan-form">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-5">
                                        <div class="py-4">
                                            ...
                                            <p class="text-muted fw-medium">No Smile plans found. Click "Sync Plans" to fetch from API.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                <div class="modal-header bg-light">
                    <h5 class="modal-title fw-bold">Add New Smile Plan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <form action="{{ route('admin.smile-data.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-semibold">Plan Name</label>
                                <input type="text" name="name" class="form-control" required placeholder="e.g. Smile 1GB">
                            </div>
                            <div class="col-md-6 mb-3">
    ...
    <div class="modal fade" id="editPlanModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                <div class="modal-header bg-light">
                    <h5 class="modal-title fw-bold">Edit Smile Plan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editButtons.forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    editForm.action = `/admin/smile-data/${id}/update`;
            ...
            if(syncForm) {
                syncForm.addEventListener('submit', function(e) {
                    ...
                    Swal.fire({
                        title: 'Sync Plans?',
                        text: "This will pull the latest Smile data plans from the API and update your database. Continue?",
                        icon: 'question',
            ...
            deleteButtons.forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    Swal.fire({
                        title: 'Delete Plan?',
                        text: "Are you sure you want to delete this Smile plan? This action cannot be undone.",
                        icon: 'warning',
                        showCancelButton: true,
                        confirmButtonColor: '#d33',
                        cancelButtonColor: '#6c757d',
