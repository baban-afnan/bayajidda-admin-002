<x-app-layout>
    <title>Bayajidda Global - eSIM Request Service</title>
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6 col-12">
                        <h3 class="mb-0 fw-bold">eSIM Request Service</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 1.25rem;">
                    <div class="card-body p-4 bg-white">
                        <form method="GET" action="{{ route('esim.index') }}">
                                ...
                                <div class="col-lg-3">
                                    <div class="d-flex gap-2">
                                        ...
                                        @if(request('status') || request('search'))
                                            <a href="{{ route('esim.index') }}" class="btn btn-outline-danger px-4 py-2 d-flex align-items-center justify-content-center">
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 1.25rem;">
            <div class="card-header bg-white py-4 border-bottom-0 d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold text-dark d-flex align-items-center">
                    <i class="ti ti-sim me-2 text-primary fs-22"></i>
                    eSIM Service Requests
                </h5>
                            ...
                            @forelse ($enrollments as $enrollment)
                                <tr>
                                    ...
                                    <td class="pe-4 text-end">
                                        <a href="{{ route('esim.show', $enrollment->id) }}" class="btn btn-icon btn-light btn-sm rounded-circle shadow-sm" data-bs-toggle="tooltip" title="View Details">
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-5">
                                        <div class="py-4">
                                            ...
                                            <h6 class="text-muted fw-normal">No eSIM records found.</h6>
                                            @if(request('search') || request('status'))
                                                <a href="{{ route('esim.index') }}" class="btn btn-link btn-sm mt-2">Clear all filters</a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
