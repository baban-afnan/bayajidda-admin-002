<x-app-layout>
    <title>Bayajidda Global - CRM Service</title>
    <div class="page-body">
                                ...
                                <div class="col-lg-3">
                                    <div class="d-flex gap-2">
                                        ...
                                        @if(request('status') || request('search'))
                                            <a href="{{ route('crm.index') }}" class="btn btn-outline-danger px-4 py-2 d-flex align-items-center justify-content-center">
                ...
                <div class="d-flex align-items-center gap-3">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                            <li><a class="dropdown-item py-2" href="{{ route('crm.export.csv') }}"><i class="ti ti-file-text me-2 text-primary"></i>Export as CSV</a></li>
                            <li><a class="dropdown-item py-2" href="{{ route('crm.export.excel') }}"><i class="ti ti-file-spreadsheet me-2 text-success"></i>Export as Excel</a></li>
                        </ul>
                    </div>
                                    ...
                                    <td colspan="7" class="text-center py-5">
                                        <div class="py-4">
                                            ...
                                            @if(request('search') || request('status'))
                                                <a href="{{ route('crm.index') }}" class="btn btn-link btn-sm mt-2">Clear all filters</a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
